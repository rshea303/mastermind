class SolutionGenerator
  ...
  def initialize
    @game_starting_colors = ["red", "blue", "green", "yellow"]                       # => ["red", "blue", "green", "yellow"]
    @new_random_solution = []                                                        # => []
    @game_default_solution = {"red" => 0, "blue" => 0, "green" => 0, "yellow" => 0}  # => {"red"=>0, "blue"=>0, "green"=>0, "yellow"=>0}
  end
...
puts sample.solution              # => nil
puts sample.solution_color_count  # => nil
end                               # => nil
